...
const Service = () => {
  ...
  const getGridCols = (length: number) => {
    ...
    if (length === 2) return "grid-cols-1 md:grid-cols-2"; // stacked 1 col mobile, 2 cols medium+
  ...
  return (
    ...
    >
      <div
        id="services-section"
        className="w-full py-12 px-4 md:px-8 lg:px-16 flex flex-col lg:grid lg:grid-cols-[1fr_3fr] gap-12 items-center"
      >
        {/* Left: Text */}
        <div className="space-y-4 text-center lg:text-left mb-8 lg:mb-0 w-full lg:w-auto">
          <h2
            className={`text-lg font-semibold ${isDark ? "from-orange-500" : "to-yellow-500"
              }`}
          >
            Our Services
          </h2>
          ...
          <p
            className={`text-lg md:text-xl ${isDark ? "text-gray-300" : "text-slate-600"
              }`}
          >
        ...
        <div className="flex flex-col items-center lg:items-end space-y-5 w-full">
          {/* Buttons */}
          {/* Buttons */}
          <div className="flex flex-col lg:flex-row justify-center lg:justify-end gap-4 w-full">
