...
const About = () => {
    ...
    <div className="w-screen min-h-screen flex items-center justify-center bg-background/80 backdrop-blur-md py-20 px-6 transition-colors duration-500">
     <div >
      ...
      <div className="relative flex items-center p-4 md:p-8 lg:p-12">
        {/* Gradient overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-orange-100 via-orange-200 to-orange-300 opacity-70 dark:from-orange-900 dark:via-orange-800 dark:to-orange-700"></div>
  ...
  className="absolute top-[42vh] right-12 md:right-16 lg:right-16 w-full max-w-sm lg:max-w-md bg-white dark:bg-gray-800 p-6 md:p-8 rounded-lg shadow-lg text-gray-800 dark:text-gray-200"
>
  <p className="mb-4">
